...
export default function Navbar() {
    ...
    const navigation = [
        { name: 'Home', href: '/home', current: currentPage == "/" ? true : false },
            ...
            {({ open }) => (
                <>
                            ...
                            <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                                <div className="flex flex-shrink-0 items-center">
                                    <div className='flex flex-row text-red-500 font-semibold'>
                                        <div className='text-gray-300'>Mo</div>
                                        <div className='transform scale-x-[-1]'>NERD</div>
                                    </div>
                                </div>
                            ...
                            <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                                ...
                                <div>
                                    ...
                                    <img
                                        ...
                                        src="./src/assets/ryanrhoads.jpeg"
                                        alt=""
                                    />
                                    </Menu.Button>
                                </div>
                    ...
                    <Disclosure.Panel className="sm:hidden">
                            <div className="fixed w-full z-50 flex flex-col space-y-1 px-2 pb-3 pt-2 bg-slate-700">
                                {navigation.map((item) => (
                                    <Disclosure.Button
                                        key={item.name}
                                        as={Link}
                                        to={item.href}
                                        onClick={() => console.log("Current Small Selection: ", item.name)}
                                        className={classNames(
                                            item.current ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white',
